...
<body>
                        ...
                        <div class="header" id="top">    
                            <div class="nav">
                             ...
                             <div class="product bgSushi">
                                ...
                                <!-- menu -->
                                <div class="tempMenu with-border-image rice">
                                    <!-- tempMakanan -->
                                        ...
                                        <?php
                                            ...
                                            ?>
                                                ...
                                                <form action="" method="post">
                                                    ...
                                                    <div class="mup" onclick="myFunction2(<?=$values['id_product']?>)"><img  class="mup" src="gallery/<?=$values["id_product"]+1?>.jpg" alt=""></div>
                                                    <div class="mdown">
                                                        <div class="mdleft">
                                                        ...
                                                        <div class="mdright">
                                                            ...
                                                            <div class="addcart" onclick="myFunction()"><button  class="btn_cart" name="cart" value=<?=$values["id_product"]?>>Add to cart</button></div>
                                                        </div>
                                                    </div>
                                                </form>
                                                </div> 
    ...
    function myFunction() {
        ...
        function myFunction2(x) {
            window.location.href="rice.php?desk="+x;
